    ...
    if content is not None or files is not None:
        try:
            for uploaded_file in files:
                if (
                    uploaded_file.file
                    and uploaded_file.file.__sizeof__() > max_file_size
                ):
                    return {
                        "status": False,
                        "message": f"File size exceeds the limit (maximum {max_file_size}MB)",
                    }
        except Exception as e:
            return {
                "status": False,
                "message": f"An error occurred while parsing the files",
            }
        ...
        try:
            ...
            return {
                "status": False,
                "message": f"An error occurred while creating a post",
            }
        ...
        if files is not None:
            try:
                ...
                return {
                    "status": False,
                    "message": "An error occurred while saving content",
                }
            ...
            if uploaded_attachments:
                try:
                    ...
                    return {
                        "status": False,
                        "message": f"An error occurred while updating a post",
                    }
